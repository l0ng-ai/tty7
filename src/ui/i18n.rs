...
pub enum L10nKey {
    ...
    RestartServer,
    OtherMachines,
    SidebarActivityWorkspacesTooltip,
    SidebarActivityOutlineTooltip,
    SidebarNewWorkspaceTooltip,
    SidebarSearchWorkspaces,
    SidebarThisComputer,
    SidebarNoWorkspaces,
    AppMenuWorkspacesPanel,
    AppMenuOutlinePanel,
    AppMenuToggleSidebarMode,
    Ok,
    SftpNoTransfers,
    SftpPanelTitleFiles,
    SftpTooltipRefresh,
    ...
    CmdRightPanelFiles,
    CmdSidebarWorkspaces,
    CmdSidebarOutline,
    CmdToggleSidebarMode,
    CmdChangeTheme,
    CmdResetFontSize,
    CmdEnterFullScreen,
    CmdClearScrollback,
...
fn translate(locale: Locale, key: L10nKey) -> &'static str {
    let (en, zh) = match key {
        ...
        L10nKey::SettingsAppHttpProxy => ("HTTP/SOCKS proxy", "HTTP/SOCKS 代理"),
        L10nKey::SettingsAppHttpProxyDesc => (
            "Optional proxy for update checks and release downloads. Examples: http://127.0.0.1:7890, socks5://127.0.0.1:1080.",
            "用于更新检查和发行版下载的可选代理。例如：http://127.0.0.1:7890、socks5://127.0.0.1:1080。",
        ),
        ...
        L10nKey::SidebarActivityWorkspacesTooltip => ("Show workspaces", "显示工作区"),
        L10nKey::SidebarActivityOutlineTooltip => ("Show outline", "显示大纲"),
        L10nKey::SidebarNewWorkspaceTooltip => ("New workspace", "新建工作区"),
        L10nKey::SidebarSearchWorkspaces => ("Search workspaces…", "搜索工作区…"),
        L10nKey::SidebarThisComputer => ("This Computer", "本机"),
        L10nKey::SidebarNoWorkspaces => ("No workspaces yet.", "还没有工作区。"),
        L10nKey::Ok => ("OK", "确定"),
        ...
        L10nKey::CmdSidebarWorkspaces => ("Sidebar: Workspaces", "侧边栏：工作区"),
        L10nKey::CmdSidebarOutline => ("Sidebar: Outline", "侧边栏：大纲"),
        L10nKey::CmdToggleSidebarMode => ("Toggle Sidebar Mode", "切换侧边栏模式"),
        ...
        L10nKey::AppMenuWorkspacesPanel => ("Workspaces Panel", "工作区面板"),
        L10nKey::AppMenuOutlinePanel => ("Outline Panel", "大纲面板"),
        L10nKey::AppMenuToggleSidebarMode => ("Toggle Sidebar Mode", "切换侧边栏模式"),
...
mod tests {
    ...
    fn zh_translations_cover_the_initial_keys() {
        for key in [
            ...
            L10nKey::SidebarActivityWorkspacesTooltip,
            L10nKey::SidebarActivityOutlineTooltip,
            L10nKey::SidebarNewWorkspaceTooltip,
            L10nKey::SidebarSearchWorkspaces,
            L10nKey::SidebarThisComputer,
            L10nKey::SidebarNoWorkspaces,
            L10nKey::AppMenuWorkspacesPanel,
            L10nKey::AppMenuOutlinePanel,
            L10nKey::AppMenuToggleSidebarMode,
            L10nKey::Ok,
            ...
            L10nKey::CmdSidebarWorkspaces,
            L10nKey::CmdSidebarOutline,
            L10nKey::CmdToggleSidebarMode,
