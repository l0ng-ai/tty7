...
fn make_binding(action: &str, keystroke: &str) -> Option<KeyBinding> {
    Some(match action {
        ...
        "ToggleSidebarMode" => KeyBinding::new(keystroke, ToggleSidebarMode, None),
        "ShowSidebarWorkspaces" => KeyBinding::new(keystroke, ShowSidebarWorkspaces, None),
        "ShowSidebarOutline" => KeyBinding::new(keystroke, ShowSidebarOutline, None),
