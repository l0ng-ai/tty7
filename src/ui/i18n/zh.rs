...
pub fn translate_zh(key: L10nKey) -> Option<&'static str> {
    Some(match key {
        ...
        L10nKey::TreeSearchFailed => "搜索失败：{error}",
        ...
        L10nKey::SshFormNameRequired => "名称为必填项。",
        L10nKey::SshFormHostRequired => "主机为必填项。",
        ...
        L10nKey::SftpTransferListFailed => "无法获取传输列表：{error}",
        ...
        L10nKey::RemoteStripReconnectingFailed => "正在重新连接 {machine}…——上次失败：{error}",
