...
pub enum L10nKey {
    ...
    SettingsUpdateSkipVersion,
    SettingsUpdateSkipped,
    SettingsUpdateUnskip,
...
mod tests {
    ...
    fn zh_translations_cover_the_initial_keys() {
        for key in [
            ...
            L10nKey::SettingsUpdateSkipVersion,
            L10nKey::SettingsUpdateSkipped,
            L10nKey::SettingsUpdateUnskip,
            L10nKey::SettingsUpdateReleaseNotes,
