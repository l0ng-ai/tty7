...
l10n_keys! {
    ...
    SshFormPortInvalid,
    SshFormJumpUnknown,
    SshFormProxyHostMissing,
    SshFormProxyPortInvalid,
    SshImportNoConfig,
    SshImportNoHosts,
    SshImportSummary,
    SshImportDropped,
    ...
    ForwardSocksLabel,
    ForwardAdd,
    ForwardFormBindPortInvalid,
    ForwardFormTargetMissing,
    ForwardAddFailed,
    ForwardAddUnreachable,
    ForwardEditNotRestored,
    ...
    RemoteStripReconnectingFailed,
    RemoteStripReconnectingAttemptFailed,
    ...
    SshPromptNewAlgorithmTitle,
    SshPromptNewAlgorithmBody,
    HostKeyOverrideNeedsYes,
    SshPromptConnect,
    SshPromptUnlock,
    SshPromptSubmit,
    HostOpsError,
