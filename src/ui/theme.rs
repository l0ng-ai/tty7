...
pub(crate) fn set_menus(cx: &mut App) {
    cx.set_menus([
        ...
        Menu::new(t(L10nKey::AppMenuView)).items([
            ...
            MenuItem::action(t(L10nKey::AppMenuWorkspacesPanel), ShowSidebarWorkspaces),
            MenuItem::action(t(L10nKey::AppMenuOutlinePanel), ShowSidebarOutline),
            MenuItem::action(t(L10nKey::AppMenuToggleSidebarMode), ToggleSidebarMode),
