...
| Key | Type | Default | |
|---|---|---|---|
| `prompt_editor` | bool | `true` | tty7's line editor at the prompt. Off hands the whole line — keys, clicks, paste — to the shell's own (ZLE, readline); prompt marks and notifications stay. |
