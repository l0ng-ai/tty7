...
| Agent | |
|---|---|
| Claude Code · Codex · TraeCode · Copilot CLI · OpenCode · Pi · Grok Build · Oh My Pi · Gemini · Droid · Qwen Code · Goose · Kimi Code · Qoder CLI · Crush · CodeBuddy · Cursor CLI · Prime Agent | Hooks available |
| Aider · Amp · Auggie · Hermes · Vibe · Antigravity · Empryo | Detected and labelled, but no status channel yet |
