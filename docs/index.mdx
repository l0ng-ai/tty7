...
<Frame>
  <video autoPlay muted loop playsInline controls poster="/images/tour-poster.webp" src="/images/tour.mp4" aria-label="A one-minute tour of tty7: agents across repos, one agent driving another, the prompt editor, diffs, dragging panes, and sessions that outlive the window" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Agent-aware" icon="robot" href="/agents/overview">
    25 coding CLIs are recognised on sight. Per-pane status dots, notifications
