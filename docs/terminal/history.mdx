...
This releases <kbd>⌃ R</kbd> and nothing else — <kbd>↑</kbd> still walks tty7's
history. To hand the whole prompt to your shell's line editor, <kbd>↑</kbd>
included, turn off the prompt editor itself —
[turning it off →](/terminal/prompt#turning-it-off)
