...
mod kind {
    ...
    pub(crate) const OUTPUT: u8 = 3;
    pub const CWD: u8 = 4;
    pub(crate) const PROMPT: u8 = 5;
    pub(crate) const EXITED: u8 = 6;
    ...
    pub(crate) const PROCS: u8 = 50;
    pub(crate) const INPUT_ACK: u8 = 51;
